...
public class OutDegreeDistribution {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Tuple2<Long, Long>> verticesWithDegree = edges.project(0).types(Long.class).groupBy(0)
	...
	public static class DegreeOfVertex implements GroupReduceFunction<Tuple1<Long>, Tuple2<Long, Long>> {
		@Override
		public void reduce(Iterable<Tuple1<Long>> tuples, Collector<Tuple2<Long, Long>> collector)
				throws Exception {
